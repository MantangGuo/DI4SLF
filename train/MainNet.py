...
class MainNet(torch.nn.Module):
    ...
    def forward(self, lf_sparse, flow_sparse, warped_lf_sparse, patch_left, patch_right):
        ...
        return ref_patch_novel.reshape(b,an_novel,r_patch_size,r_patch_size), patch_novel.reshape(b,an_novel,r_patch_size,r_patch_size), leftNovelView.reshape(b,an_novel,r_patch_size,r_patch_size), rightNovelView.reshape(b,an_novel,r_patch_size,r_patch_size),
